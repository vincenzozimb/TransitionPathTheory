...
with open('tpt/data.csv', 'r') as csvfile:
...
plt.tight_layout()
plt.savefig("tpt/images/p&g.png")
...
plt.savefig("tpt/images/c_tpt.png")
...
plt.savefig("tpt/images/m_tpt.png")
...
plt.tight_layout()
plt.savefig("tpt/images/J_tpt.png")
